...
kikit panelize \
  --layout "plugin; code: ../KiKit/multi_grid_layout.py.Plugin; cols: 3; space: 3mm; rotation: 0deg; boards: $count * controller_pcb/controller_pcb.kicad_pcb, $count * build/led_pcb/led_pcb.kicad_pcb" \
  --tabs "fixed; width: 4mm; hcount: 1; vcount: 1;" \
  --cuts "mousebites; drill: 0.5mm; spacing: 1mm; offset: -0.5mm; prolong: 2.75mm" \
